...
def _report_rows(submissions):
    ...
    for item in submissions:
        rows.append([
            ...
            item.activity.title,
            item.activity.due_start or "",
            item.activity.due_end or "",
            getattr(item.apprentice, "followup_moment1_start", "") or "",
            getattr(item.apprentice, "followup_moment1_end", "") or "",
            getattr(item.apprentice, "followup_moment2_start", "") or "",
            getattr(item.apprentice, "followup_moment2_end", "") or "",
            getattr(item.apprentice, "followup_moment3_start", "") or "",
            getattr(item.apprentice, "followup_moment3_end", "") or "",
            getattr(item.apprentice, "followup_moment4_start", "") or "",
            getattr(item.apprentice, "followup_moment4_end", "") or "",
...
def export_xlsx():
    ...
    ws.title = "Reporte"
    headers = [
        "Ficha", "Aprendiz", "Documento", "Programa", "Instructor lider", "Instructor seguimiento",
        "Municipio", "Tipo", "Evidencia", "Fecha inicio evidencia", "Fecha fin evidencia",
        "Momento 1 inicio", "Momento 1 fin", "Momento 2 inicio", "Momento 2 fin",
        "Momento 3 inicio", "Momento 3 fin", "Momento 4 inicio", "Momento 4 fin",
