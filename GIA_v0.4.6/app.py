...
from flask import Flask, url_for, current_app, render_template, send_from_directory, Response
...
def create_app(config: dict | None = None) -> Flask:
    ...
    """
    from services.text import normalize_text  # registrar filtro Jinja desde services/text.py
    ...
    try:
        ...
        if hasattr(extensions, "init_extensions"):
            ...
            # Backwards compatibility: if init_extensions is not present, try to init known extensions
    ...
    # NOTE: Schema changes must be managed via migrations (Flask-Migrate / Alembic).
    # The previous automatic ALTER TABLE / UPDATE logic was removed to avoid
    # performing DDL at runtime. Use flask db migrate / flask db upgrade instead.
