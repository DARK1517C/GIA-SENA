...
class Apprentice(db.Model):
    ...
    group_id = db.Column(db.Integer, db.ForeignKey("training_group.id"), nullable=True, index=True)
    group_number = db.Column(db.String(30), nullable=False, index=True)
    document_type = db.Column(db.String(30), nullable=False)
    document_number = db.Column(db.String(30), unique=True, nullable=False, index=True)
    ...
    followup_moment1_start = db.Column(db.String(40), nullable=True)
    followup_moment1_end = db.Column(db.String(40), nullable=True)
    followup_moment2_start = db.Column(db.String(40), nullable=True)
    followup_moment2_end = db.Column(db.String(40), nullable=True)
    followup_moment3_start = db.Column(db.String(40), nullable=True)
    followup_moment3_end = db.Column(db.String(40), nullable=True)
    followup_moment4_start = db.Column(db.String(40), nullable=True)
    followup_moment4_end = db.Column(db.String(40), nullable=True)
    ...
    continues_company = db.Column(db.String(30), nullable=True)
    individual_management = db.Column(db.Text, nullable=True)
    followup_moments = db.Column(db.String(200), nullable=True)
    evaluation_date = db.Column(db.String(40), nullable=True)
    english_results = db.Column(db.String(120), nullable=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)

    group = db.relationship("TrainingGroup", back_populates="apprentices", lazy="joined")
